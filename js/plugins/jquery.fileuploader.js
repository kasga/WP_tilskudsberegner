				...
				f = {
					...
					bindUnbindEvents: function(bind) {
						...
						*/
						...
						$('.fileuploader-input-button').click(function(e) {
							e.preventDefault();
							s.trigger('click');
							...
							switch ((typeof n.changeInput + "").toLowerCase()) {
								case 'boolean':
									o = $('<div class="fileuploader-input">' +
											  ...
											  '<div class="fileuploader-input-button"></div>' + 
										  '</div>');
									break;
								case 'string':
									if(n.changeInput != ' ')
						...
						renderImage: function(item, force_render) {
							var m = item.html.find('.fileuploader-item-image'),
								setImageThumb = function(img) {
									var $img = $(img);
									// Just set the background-image already :P
									m.removeClass('fileupload-no-thumbnail fileuploader-loading').css('background-image','url('+ $img.attr('src') +')');
									/*
                                    if($img.is('img'))
	...
	$.fn.fileuploader.defaults = {
        ...
        thumbnails: {
			...
			item: '<li class="fileuploader-item">' +
                       '<div class="columns">' +
                           ...
                           '<div class="column-actions">' +
							   ...
							   '<a class="fileuploader-action fileuploader-action-remove"></a>' +
                           '</div>' +
                       '</div>' +
            ...
            onItemRemove: function(html) {
				...
				html.css(fade).slideUp('400', function() {
